...
{
	Db::getInstance()->Execute('INSERT INTO '._DB_PREFIX_.'basecondition(label, tablename) values ("'.pSQL(Tools::getValue('label')).'", "'.pSQL(Tools::getValue('tablename')).'")');
	Tools::redirect('modules/segmentmodule/config.php');
}
elseif (Tools::getValue('type') == 'sourceadd')
{
	Db::getInstance()->Execute('INSERT INTO '._DB_PREFIX_.'sourcecondition(id_basecondition,label, jointable) values ('.pSQL(Tools::getValue('idbase')).',"'.pSQL(Tools::getValue('label')).'", "'.pSQL(Tools::getValue('jointable')).'")');
...
{
	Db::getInstance()->Execute('INSERT INTO '._DB_PREFIX_.'fieldcondition(id_sourcecondition,label, field) values ('.pSQL(Tools::getValue('idsource')).',"'.pSQL(Tools::getValue('label')).'", "'.pSQL(Tools::getValue('field')).'")');
