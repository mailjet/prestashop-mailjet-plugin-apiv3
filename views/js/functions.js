...
function updateSource(idbase, idrule)
{
    ...
    if (typeof ajaxFile !== 'undefined') {
        $.post(
            ajaxFile,
            {'action': 'getSource', 'token': tokenV, 'baseID': idbase, 'ID': idrule, 'id_employee': id_employee},
            function (data) {
...
function updateIndic(idsource, idrule)
{
    ...
    $.post(
        ajaxFile,
        {'action': 'getIndic', 'token': tokenV, 'sourceID': idsource, 'ID': idrule, 'id_employee': id_employee},
        function (data) {
...
function saveFilter()
{
    ...
    $.post(
        ajaxFile,
        $("#mainForm").serialize() + "&token=" + tokenV +
...
function loadFilterInfo(idfilter)
{
    ...
    $.post(
        ajaxFile,
        {'idfilter': idfilter, 'action': 'loadFilterInfo', 'token': tokenV, 'id_employee': id_employee},
        function (data) {
            info = jQuery.parseJSON(data);
...
function deleteFilter(idfilter)
{
    $.post(
        ajaxFile,
        {'idfilter': idfilter, 'action': 'deleteFilter', token: tokenV, 'id_employee': id_employee},
        function (data) {
            if (data) {
