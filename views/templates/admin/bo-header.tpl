...
<script type="text/javascript">
    ...
    var MJ_REQUEST_PAGE_TYPE = "{$MJ_REQUEST_PAGE_TYPE|escape:'javascript':'UTF-8'|default:''}";

    // Generate from the xml
    {foreach from=$MJ_available_pages key=MJ_page_key item=MJ_page_value}
    var {$MJ_page_key|escape:'javascript':'UTF-8'} = "{$MJ_page_value|escape:'javascript':'UTF-8'|default:''}";
    {/foreach}
</script>