...
<fieldset>
	...
	<div>
        ...
        <!--<p><label>API Key :</label><input type="text" name="mj_api_key" value="{$account.API_KEY|escape|default:''}" size="80" /></p>
        <p><label>Secret Key :</label><input type="text" name="mj_secret_key" value="{$account.SECRET_KEY|escape|default:''}" size="80" /></p>-->
