...
<div id="login_content">
    <div id="login_form">
        <fieldset>
            ...
            <form id="MJ_auth_form" action="{$smarty.server.REQUEST_URI|escape:'htmlall':'UTF-8'|default:''}" method="POST">
                <ul>
                    <li>
                        <label for="MJ_email_address">{l s='Email address' mod='mailjet'}</label>
                        <input id="MJ_email_address" type="text" name="MJ_email_address" value="{$MJ_email_address|escape:'htmlall':'UTF-8'}" />
                    </li>
                    <li>
                        <label for="MJ_passwd">
                            {l s='Password' mod='mailjet'}
                        </label>
                        <input id="MJ_passwd" class="MJ_passwd" type="password" name="MJ_passwd" value="{$MJ_passwd|escape:'htmlall':'UTF-8'}" />
                    </li>
                </ul>
